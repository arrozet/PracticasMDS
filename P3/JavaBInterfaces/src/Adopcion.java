...
public class Adopcion {
     ...
     */
    public void setAdoptante(Socio adoptante) throws RefugioAnimalesException {
        if (adoptante == null) {
            throw new IllegalArgumentException("El adoptante no puede ser null.");
        }
        if (!adoptante.esAdoptante()){
            throw new RefugioAnimalesException("El socio no es adoptante");
        }
        this.adoptante = adoptante;
    }
