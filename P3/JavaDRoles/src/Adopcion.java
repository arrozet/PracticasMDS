...
public class Adopcion {
    ...
    private Socio socio; // Socio que realizó la adopción
     ...
     * @param socio Adoptante que adopta el animal. No puede ser null.
     * @throws IllegalArgumentException Si alguno de los parámetros es null.
     */
    public Adopcion(Date fecha, Animal animal, Socio socio) {
        if (fecha == null) {
     ...
     *
     * @param socio Nuevo adoptante. No puede ser null.
     * @throws IllegalArgumentException Si el adoptante es null.
     */
    public void setAdoptante(Socio socio) {
        if (socio == null) {
            throw new IllegalArgumentException("El adoptante no puede ser null.");
        }
        this.socio = socio;
